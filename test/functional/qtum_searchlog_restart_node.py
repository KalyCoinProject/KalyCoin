...
from test_framework.kalycoinconfig import ENABLE_REDUCED_BLOCK_TIME

import sys


RPC_INVALID_PARAMETER = -8
class KalycoinRPCSearchlogsTestModified(BitcoinTestFramework):
...
if __name__ == '__main__':
    KalycoinRPCSearchlogsTestModified().main()
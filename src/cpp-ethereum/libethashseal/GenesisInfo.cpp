...
#include "genesis/kalycoinMainNetwork.cpp"
...
#include "genesis/test/kalycoinTestNetwork.cpp"
...
std::string const& dev::eth::genesisInfo(Network _n)
{
    ...
    {
    //Client genesis
    case Network::kalycoinMainNetwork: return c_genesisInfoKalycoinMainNetwork;
    case Network::MainNetwork: return c_genesisInfoMainNetwork;
    case Network::Ropsten: return c_genesisInfoRopsten;

    //Test genesis
    case Network::kalycoinTestNetwork: return c_genesisInfoKalycoinTestNetwork;
...
h256 const& dev::eth::genesisStateRoot(Network _n)
{
    switch (_n)
    {
    case Network::kalycoinMainNetwork: return c_genesisStateRootKalycoinMainNetwork;
    case Network::kalycoinTestNetwork: return c_genesisStateRootKalycoinTestNetwork;

...
////////////////////////////////////////////////////////////// // kalycoin
    void setKalycoinSchedule(EVMSchedule _kalycoinSchedule) const { kalycoinSchedule = _kalycoinSchedule; }

    EVMSchedule& getKalycoinSchedule() const { return kalycoinSchedule; }
...
private:
    ...
    mutable EVMSchedule kalycoinSchedule; // kalycoin

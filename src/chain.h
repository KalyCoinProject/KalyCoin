...
public:
    ...
    bool IsProofOfWork() const // kalycoin
    {
...
public:
    ...
    SERIALIZE_METHODS(CDiskBlockIndex, obj)
    {
        ...
        READWRITE(obj.hashStateRoot); // kalycoin
        READWRITE(obj.hashUTXORoot); // kalycoin
        READWRITE(obj.nStakeModifier);
        READWRITE(obj.prevoutStake);
        READWRITE(obj.hashProof);
        READWRITE(obj.vchBlockSigDlgt); // kalycoin
    }

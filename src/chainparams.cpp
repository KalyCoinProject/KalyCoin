...
static CBlock CreateGenesisBlock(const char* pszTimestamp, const CScript& genesisOutputScript, uint32_t nTime, uint32_t nNonce, uint32_t nBits, int32_t nVersion, const CAmount& genesisReward)
{
    ...
    genesis.hashStateRoot = uint256(h256Touint(dev::h256("e965ffd002cd6ad0e2dc402b8044de833e06b23127ea8c3d80aec91410771495"))); // kalycoin
    genesis.hashUTXORoot = uint256(h256Touint(dev::sha3(dev::rlp("")))); // kalycoin
    return genesis;
}
...
{
    const char* pszTimestamp = "May 10, 2022 Bitcoin Recovers to $32K After Dipping Below $30K";
...
public:
    CMainParams() {
        ...
        consensus.nSubsidyHalvingInterval = 985500; // kalycoin halving every 4 years
        consensus.BIP16Exception = uint256S("0x00000000b2e440e183df808c8a5adc1e2a6d7cb20584aed2fee9c7b360b451db");
        consensus.BIP34Height = 0;
        consensus.BIP34Hash = uint256S("0x00000000b2e440e183df808c8a5adc1e2a6d7cb20584aed2fee9c7b360b451db");
        ...
        genesis = CreateGenesisBlock(1643323319, 4161309690, 0x1d00ffff, 1, 50 * COIN); 
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x00000000b2e440e183df808c8a5adc1e2a6d7cb20584aed2fee9c7b360b451db"));
        assert(genesis.hashMerkleRoot == uint256S("0x076b1fd6f0957ce614da18f1cd4954cd0fc742a06322458502fd09c644ea14e9"));
        ...
        //  vSeeds.emplace_back("kalycoin3.dynu.net"); // Kalycoin mainnet
        //  vSeeds.emplace_back("kalycoin5.dynu.net"); // Kalycoin mainnet
        //  vSeeds.emplace_back("kalycoin6.dynu.net"); // Kalycoin mainnet
        //  vSeeds.emplace_back("kalycoin7.dynu.net"); // Kalycoin mainnet
        ...
        consensus.nSubsidyHalvingIntervalV2 = consensus.nBlocktimeDownscaleFactor*985500; // kalycoin halving every 4 years (nSubsidyHalvingInterval * nBlocktimeDownscaleFactor)
...
public:
    CTestNetParams() {
        ...
        // The best chain should have at least this much work.
        consensus.nMinimumChainWork = uint256S("0x00"); // kalycoin
        ...
        genesis = CreateGenesisBlock(1653267550, 2011070964, 0x1d00ffff, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x00000000c8b588aca0a5de51c7baf06fff38091050e164384593a37f0b38074a"));
        assert(genesis.hashMerkleRoot == uint256S("0x076b1fd6f0957ce614da18f1cd4954cd0fc742a06322458502fd09c644ea14e9"));

        vFixedSeeds.clear();
        vSeeds.clear();
        // nodes with support for servicebits filtering should be at the top
        //vSeeds.emplace_back("kalycoin4.dynu.net"); // Kalycoin testnet
...
public:
    explicit CRegTestParams(const ArgsManager& args) {
        ...
        consensus.BIP16Exception = uint256S("0x6654ab57d20612afb94307fd630c72bde4ab5d492f624dda649dd73993359da7568");
        consensus.BIP34Height = 0; // BIP34 activated on regtest (Used in functional tests)
        consensus.BIP34Hash = uint256S("0x6654ab57d20612afb94307fd630c72bde4ab5d492f624dda649dd73993359da7568");
        ...
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x6654ab57d20612afb94307fd630c72bde4ab5d492f624dda649dd73993359da7568"));
        assert(genesis.hashMerkleRoot == uint256S("0x076b1fd6f0957ce614da18f1cd4954cd0fc742a06322458502fd09c644ea14e9"));
...
public:
    ...
    : CRegTestParams(args)
    {
        ...
        // KLC have 500 blocks of maturity, increased values for regtest in unit tests in order to correspond with it
...
{
    return dev::eth::Network::kalycoinMainNetwork;
}

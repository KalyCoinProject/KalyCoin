...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " kalycoin-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  kalycoin-tx [options] <hex-tx> [commands]  Update hex-encoded kalycoin transaction\n" +
            "or:     kalycoin-tx [options] -create [commands]   Create hex-encoded kalycoin transaction\n" +
            "\n";

...
UniValue blockheaderToJSON(const CBlockIndex* tip, const CBlockIndex* blockindex)
{
    ...
    result.pushKV("hashStateRoot", blockindex->hashStateRoot.GetHex()); // kalycoin
    result.pushKV("hashUTXORoot", blockindex->hashUTXORoot.GetHex()); // kalycoin

    if(blockindex->IsProofOfStake()){
        result.pushKV("prevoutStakeHash", blockindex->prevoutStake.hash.GetHex()); // kalycoin
        result.pushKV("prevoutStakeVoutN", (int64_t)blockindex->prevoutStake.n); // kalycoin
    }
...
UniValue blockToJSON(const CBlock& block, const CBlockIndex* tip, const CBlockIndex* blockindex, bool txDetails)
{
    ...
    result.pushKV("hashStateRoot", block.hashStateRoot.GetHex()); // kalycoin
    result.pushKV("hashUTXORoot", block.hashUTXORoot.GetHex()); // kalycoin
...
static std::vector<RPCResult> MempoolEntryDescription() { return {
    ...
    RPCResult{RPCResult::Type::NUM, "size", "(DEPRECATED) same as vsize. Only returned if kalycoind is started with -deprecatedrpc=size\n"
...
UniValue getdelegationinfoforaddress(const JSONRPCRequest& request)
{
            RPCHelpMan{"getdelegationinfoforaddress",
                ...
                {
                    {"address", RPCArg::Type::STR, RPCArg::Optional::NO, "The kalycoin address string"},
                },
                RPCResult{
                    RPCResult::Type::OBJ, "", "",
                    {
    ...
    KalycoinDelegation kalycoinDelegation;
    Delegation delegation;
    uint160 address = uint160(*pkhash);
    if(!kalycoinDelegation.GetDelegation(address, delegation)) {
        throw JSONRPCError(RPC_INTERNAL_ERROR, "Failed to get delegation");
    }
    bool verified = kalycoinDelegation.VerifyDelegation(address, delegation);
...
UniValue getdelegationsforstaker(const JSONRPCRequest& request)
{
            RPCHelpMan{"getdelegationsforstaker",
                ...
                {
                    {"address", RPCArg::Type::STR, RPCArg::Optional::NO, "The kalycoin address string for staker"},
                },
               RPCResult{
            RPCResult::Type::ARR, "", "",
                {
    ...
    if(!kalycoinDelegation.FilterDelegationEvents(events, filter)) {
        throw JSONRPCError(RPC_INTERNAL_ERROR, "Failed to get delegations for staker");
    }
    std::map<uint160, Delegation> delegations = kalycoinDelegation.DelegationsFromEvents(events);
                        ...
                        {RPCResult::Type::OBJ, "scriptPubKey", "",
                            {
                                ...
                                {RPCResult::Type::ARR, "addresses", "array of kalycoin addresses",
                                    {{RPCResult::Type::STR, "address", "kalycoin address"}}},
                            }},
...
static UniValue krc20name(const JSONRPCRequest& request)
{
            RPCHelpMan{"krc20name",
                ...
                RPCExamples{
                    HelpExampleCli("krc20name", "\"eb23c0b3e6042821da281a2e2364feb22dd543e3\"")
            + HelpExampleRpc("krc20name", "\"eb23c0b3e6042821da281a2e2364feb22dd543e3\"")
                },
            }.Check(request);
...
static UniValue krc20symbol(const JSONRPCRequest& request)
{
            RPCHelpMan{"krc20symbol",
                ...
                RPCExamples{
                    HelpExampleCli("krc20symbol", "\"eb23c0b3e6042821da281a2e2364feb22dd543e3\"")
            + HelpExampleRpc("krc20symbol", "\"eb23c0b3e6042821da281a2e2364feb22dd543e3\"")
                },
            }.Check(request);
...
static UniValue krc20totalsupply(const JSONRPCRequest& request)
{
            RPCHelpMan{"krc20totalsupply",
                ...
                RPCExamples{
                    HelpExampleCli("krc20totalsupply", "\"eb23c0b3e6042821da281a2e2364feb22dd543e3\"")
            + HelpExampleRpc("krc20totalsupply", "\"eb23c0b3e6042821da281a2e2364feb22dd543e3\"")
                },
            }.Check(request);
...
static UniValue krc20decimals(const JSONRPCRequest& request)
{
            RPCHelpMan{"krc20decimals",
                ...
                RPCExamples{
                    HelpExampleCli("krc20decimals", "\"eb23c0b3e6042821da281a2e2364feb22dd543e3\"")
            + HelpExampleRpc("krc20decimals", "\"eb23c0b3e6042821da281a2e2364feb22dd543e3\"")
                },
            }.Check(request);
...
static UniValue krc20balanceof(const JSONRPCRequest& request)
{
            RPCHelpMan{"krc20balanceof",
                "\nReturns the token balance for address\n",
                {
                    {"contractaddress", RPCArg::Type::STR_HEX, RPCArg::Optional::NO, "The contract address"},
                    {"address", RPCArg::Type::STR, RPCArg::Optional::NO,  "The kalycoin address to check token balance"},
                },
                RPCResult{
                    RPCResult::Type::STR, "balance", "The token balance of the chosen address"},
                RPCExamples{
                    HelpExampleCli("krc20balanceof", "\"eb23c0b3e6042821da281a2e2364feb22dd543e3\" \"QX1GkJdye9WoUnrE2v6ZQhQ72EUVDtGXQX\"")
            + HelpExampleRpc("krc20balanceof", "\"eb23c0b3e6042821da281a2e2364feb22dd543e3\" \"QX1GkJdye9WoUnrE2v6ZQhQ72EUVDtGXQX\"")
                },
            }.Check(request);
...
static UniValue krc20allowance(const JSONRPCRequest& request)
{
            RPCHelpMan{"krc20allowance",
                "\nReturns remaining tokens allowed to spend for an address\n",
                {
                    {"contractaddress", RPCArg::Type::STR_HEX, RPCArg::Optional::NO, "The contract address"},
                    {"addressFrom", RPCArg::Type::STR, RPCArg::Optional::NO,  "The kalycoin address of the account owning tokens"},
                    {"addressTo", RPCArg::Type::STR, RPCArg::Optional::NO,  "The kalycoin address of the account able to transfer the tokens"},
                },
                RPCResult{
                    RPCResult::Type::STR, "allowance", "Amount of remaining tokens allowed to spent"},
                RPCExamples{
                    HelpExampleCli("krc20allowance", "\"eb23c0b3e6042821da281a2e2364feb22dd543e3\" \"QX1GkJdye9WoUnrE2v6ZQhQ72EUVDtGXQX\" \"QM72Sfpbz1BPpXFHz9m3CdqATR44Jvaydd\"")
            + HelpExampleRpc("krc20allowance", "\"eb23c0b3e6042821da281a2e2364feb22dd543e3\" \"QX1GkJdye9WoUnrE2v6ZQhQ72EUVDtGXQX\" \"QM72Sfpbz1BPpXFHz9m3CdqATR44Jvaydd\"")
                },
            }.Check(request);
...
static UniValue krc20listtransactions(const JSONRPCRequest& request)
{
            RPCHelpMan{"krc20listtransactions",
                "\nReturns transactions history for a specific address.\n",
                {
                    {"contractaddress", RPCArg::Type::STR_HEX, RPCArg::Optional::NO, "The contract address."},
                    {"addresss", RPCArg::Type::STR, RPCArg::Optional::NO,  "The kalycoin address to get history for."},
            ...
            RPCResult::Type::ARR, "", "",
                {
                    {RPCResult::Type::OBJ, "", "",
                        {
                            {RPCResult::Type::STR, "receiver", "The receiver kalycoin address"},
                            {RPCResult::Type::STR, "sender", "The sender kalycoin address"},
                ...
                RPCExamples{
                    HelpExampleCli("krc20listtransactions", "\"eb23c0b3e6042821da281a2e2364feb22dd543e3\" \"QX1GkJdye9WoUnrE2v6ZQhQ72EUVDtGXQX\"")
            + HelpExampleCli("krc20listtransactions", "\"eb23c0b3e6042821da281a2e2364feb22dd543e3\" \"QX1GkJdye9WoUnrE2v6ZQhQ72EUVDtGXQX\" 0 6")
            + HelpExampleRpc("krc20listtransactions", "\"eb23c0b3e6042821da281a2e2364feb22dd543e3\" \"QX1GkJdye9WoUnrE2v6ZQhQ72EUVDtGXQX\"")
            + HelpExampleRpc("krc20listtransactions", "\"eb23c0b3e6042821da281a2e2364feb22dd543e3\" \"QX1GkJdye9WoUnrE2v6ZQhQ72EUVDtGXQX\" 0 6")
                },
            }.Check(request);
...
{ //  category              name                      actor (function)         argNames
  //  --------------------- ------------------------  -----------------------  ----------
    ...
    { "blockchain",         "krc20name",              &krc20name,              {"address"} },
    { "blockchain",         "krc20symbol",            &krc20symbol,            {"address"} },
    { "blockchain",         "krc20totalsupply",       &krc20totalsupply,       {"address"} },
    { "blockchain",         "krc20decimals",          &krc20decimals,          {"address"} },
    { "blockchain",         "krc20balanceof",         &krc20balanceof,         {"contractaddress", "address"} },
    { "blockchain",         "krc20allowance",         &krc20allowance,         {"contractaddress", "addressFrom", "addressTo"} },
    { "blockchain",         "krc20listtransactions",  &krc20listtransactions,  {"contractaddress", "address", "startblock", "minconf"} },

...
/**
 * @brief The KalycoinLedger class Communicate with the kalycoin ledger
 */
class KalycoinLedger {
    
public:
    /**
     * @brief KalycoinLedger Constructor
     */
    KalycoinLedger();

    /**
     * @brief ~KalycoinLedger Destructor
     */
    virtual ~KalycoinLedger();
     ...
     * @return
     */
    static KalycoinLedger &instance();
...
private:
    KalycoinLedger(const KalycoinLedger&);
    KalycoinLedger& operator=(const KalycoinLedger&);
    KalycoinLedgerPriv* d;
};
#endif

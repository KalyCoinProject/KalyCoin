#ifndef KLCDELEGATION_H
#define KLCDELEGATION_H
#include <string>
#include <vector>
#include <map>
#include <stdint.h>
...
/**
 * @brief The IKalycoinStaker class Delegation filter
 */
...
/**
 * @brief The KalycoinDelegation class Communicate with the kalycoin delegation contract
 */
class KalycoinDelegation {
    
public:
    /**
     * @brief KalycoinDelegation Constructor
     */
    KalycoinDelegation();

    /**
     * @brief ~KalycoinDelegation Destructor
     */
    virtual ~KalycoinDelegation();
...
private:
    KalycoinDelegation(const KalycoinDelegation&);
    KalycoinDelegation& operator=(const KalycoinDelegation&);
    KalycoinDelegationPriv* priv;
};
#endif

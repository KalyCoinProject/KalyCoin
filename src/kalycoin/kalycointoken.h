...
public:
    KalycoinToken();
    virtual ~KalycoinToken();

    void setKalycoinTokenExec(KalycoinTokenExec* tokenExec);
    ...
    // Static functions
    static bool ToHash160(const std::string& strKalycoinAddress, std::string& strHash160);
    static bool ToKalycoinAddress(const std::string& strHash160, std::string& strKalycoinAddress);
...
private:
    ...
    KalycoinToken(KalycoinToken const&);
    KalycoinToken& operator=(KalycoinToken const&);

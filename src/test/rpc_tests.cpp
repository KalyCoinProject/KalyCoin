...
BOOST_AUTO_TEST_CASE(rpc_format_monetary_values)
{
    ...
    BOOST_CHECK(ValueFromAmount(50000000024999990LL).write() == "500000000.24999990");
    BOOST_CHECK(ValueFromAmount(50000000024999999LL).write() == "500000000.24999999");
    BOOST_CHECK(ValueFromAmount(50000000025000000LL).write() == "500000000.25000000");
...
BOOST_AUTO_TEST_CASE(rpc_parse_monetary_values)
{
    ...
    BOOST_CHECK_EQUAL(AmountFromValue(ValueFromString("500000000.2499999")), 50000000024999990LL);
    BOOST_CHECK_EQUAL(AmountFromValue(ValueFromString("500000000.24999999")), 50000000024999999LL);
    BOOST_CHECK_EQUAL(AmountFromValue(ValueFromString("500000000.25")), 50000000025000000LL);

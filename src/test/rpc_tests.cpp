...
BOOST_AUTO_TEST_CASE(rpc_format_monetary_values)
{
    ...
    BOOST_CHECK(ValueFromAmount(12500000024999990LL).write() == "125000000.24999990");
    BOOST_CHECK(ValueFromAmount(12500000024999999LL).write() == "125000000.24999999");
    BOOST_CHECK(ValueFromAmount(12500000025000000LL).write() == "125000000.25000000");
...
BOOST_AUTO_TEST_CASE(rpc_parse_monetary_values)
{
    ...
    BOOST_CHECK_EQUAL(AmountFromValue(ValueFromString("125000000.2499999")), 12500000024999990LL);
    BOOST_CHECK_EQUAL(AmountFromValue(ValueFromString("125000000.24999999")), 12500000024999999LL);
    BOOST_CHECK_EQUAL(AmountFromValue(ValueFromString("125000000.25")), 12500000025000000LL);

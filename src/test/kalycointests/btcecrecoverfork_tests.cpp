...
//    initState();
    ...
    std::vector<KalycoinTransaction> txBtcEcrecover;
    txBtcEcrecover.push_back(createKalycoinTransaction(CODE[1], 0, GASLIMIT, dev::u256(1), ++hashTx, proxy));
    txBtcEcrecover.push_back(createKalycoinTransaction(CODE[2], 0, GASLIMIT, dev::u256(1), ++hashTx, proxy));
    txBtcEcrecover.push_back(createKalycoinTransaction(CODE[3], 0, GASLIMIT, dev::u256(1), ++hashTx, proxy));
    txBtcEcrecover.push_back(createKalycoinTransaction(CODE[4], 0, GASLIMIT, dev::u256(1), ++hashTx, proxy));

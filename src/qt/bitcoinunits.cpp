...
QString BitcoinUnits::longName(int unit)
{
    ...
    case uBTC: return QString::fromUtf8("μKLC (bits)");
...
QString BitcoinUnits::description(int unit)
{
    switch(unit)
    {
    case BTC: return QString("Kalycoins");
    case mBTC: return QString("Milli-Kalycoins (1 / 1" THIN_SP_UTF8 "000)");
    case uBTC: return QString("Micro-Kalycoins (bits) (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");

#ifndef KLCVERSIONCHECKER_H
#define KLCVERSIONCHECKER_H

#include <QObject>

#define KLC_RELEASES "https://github.com/kalycoinproject/kalycoin/releases"
...
class KalycoinVersionChecker : public QObject
{
    Q_OBJECT
public:
    explicit KalycoinVersionChecker(QObject *parent = 0);
    ~KalycoinVersionChecker();

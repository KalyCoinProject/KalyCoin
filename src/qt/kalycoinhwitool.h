...
/**
 * @brief The KalycoinHwiTool class Communicate with the Kalycoin Hardware Wallet Interface Tool
 */
class KalycoinHwiTool : public QObject
{
    Q_OBJECT
public:
    /**
     * @brief KalycoinHwiTool Constructor
     * @param parent Parent object
     */
    explicit KalycoinHwiTool(QObject *parent = nullptr);

    /**
     * @brief ~KalycoinHwiTool Destructor
     */
    ~KalycoinHwiTool();

...
class KalycoinStyle : public QProxyStyle
{
public:
    KalycoinStyle()
    {
...
void StyleSheet::setStyleSheet(QApplication *app, const QString& style_name)
{
    ...
    KalycoinStyle* kalycoinStyle = new KalycoinStyle;
    kalycoinStyle->setBaseStyle(mainStyle);
    app->setStyle(kalycoinStyle);
...
{
    return QStringList() << "Light yellow theme" << "Dark blue theme" << "Dark theme";
}

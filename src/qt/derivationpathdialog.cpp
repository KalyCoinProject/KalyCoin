    ...
    ui(new Ui::DerivationPathDialog)
{
    ...
    ui->txtLegacy->setText(KalycoinHwiTool::derivationPathPKH());
    ui->txtLegacy->setPlaceholderText(KalycoinHwiTool::derivationPathPKH());
    ...
    ui->txtP2SH->setText(KalycoinHwiTool::derivationPathP2SH());
    ui->txtP2SH->setPlaceholderText(KalycoinHwiTool::derivationPathP2SH());
    ...
    ui->txtSegWit->setText(KalycoinHwiTool::derivationPathBech32());
    ui->txtSegWit->setPlaceholderText(KalycoinHwiTool::derivationPathBech32());

...
#include <QPushButton>
#include <QVBoxLayout>
#include <qt/kalycoinpushbutton.h>
    ...
    walletFrame(qobject_cast<WalletFrame*>(parent))
{
    ...
    QPushButton *exportButton = new KalycoinPushButton(tr("&Export"), this);
    ...
    KRCTokenPage = new KRCToken(platformStyle);
    ...
    // Pass through messages from KRCTokenPage
    connect(KRCTokenPage, &KRCToken::message, this, &WalletView::message);
...
void WalletView::setClientModel(ClientModel *_clientModel)
{
    ...
    KRCTokenPage->setClientModel(_clientModel);
...
void WalletView::setWalletModel(WalletModel *_walletModel)
{
    ...
    KRCTokenPage->setModel(_walletModel);
